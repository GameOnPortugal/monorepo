...
| **M10.7** | ✅ **DONE (2026-08-22)** — **Winner persistence + historical backfill.** Backfilled in production on 2026-08-23: 1,444 messages scanned, **139 bot announcements, 137 weeks recorded**, 2 unresolved, 0 duplicate weeks. (A pre-implementation probe said "178 announcements" — it did not filter to bot authors, so it counted members quoting them. See the GLOBAL-PLAN M10.7 row.) | bot (migration + job + CLI) | — |
