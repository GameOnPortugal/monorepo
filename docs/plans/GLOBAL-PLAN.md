...
| M7 Trophies | 8 | 2 | #24 (M7.1 PSNProfiles source, M7.2 points ladder). The data-producing side still does not run — M7.3's sync job is the one that unfreezes the leaderboard |
